...
HD_PWD='C:/Users/Locke/VivadoProjects/VGA_Pong/VGA_Pong.runs/design_1_button_Debouncer_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_button_Debouncer_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_button_Debouncer_1_0.tcl
