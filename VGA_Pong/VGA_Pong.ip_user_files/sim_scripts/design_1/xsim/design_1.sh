...
#
# Script generated by Vivado on Mon Jun 02 04:44:46 -0700 2025
...
simulate()
{
  xsim design_1 -key {Behavioral:pixel_gen:Functional:design_1} -tclbatch cmd.tcl -protoinst "protoinst_files/design_1.protoinst" -log simulate.log
}
